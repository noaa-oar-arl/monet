...
def make_test_dataarrays():
    ...
    data2 = data1 + 1
    da1 = xr.DataArray(data1, coords={"latitude": lat, "longitude": lon}, dims=["latitude", "longitude"])
    da2 = xr.DataArray(data2, coords={"latitude": lat, "longitude": lon}, dims=["latitude", "longitude"])
    return da1, da2
