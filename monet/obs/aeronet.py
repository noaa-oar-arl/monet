...
class AERONET(object):
    def __init__(self):
        ...
        self.colnames = ['siteid', 'date', 'time', 'Day_of_Year', 'Day_of_Year(Fraction)', 'AOD_1640nm',
    ...
    def read_aeronet(self):
        ...
        df = pd.read_csv(StringIO(s), usecols=self.usecols, names=self.colnames, parse_dates=[[1, 2]],
                         infer_datetime_format=True, header=None, sep=None, engine='python', na_values=-999, skiprows=6)
